...
public class MisionRestController {
  ...
  http://127.0.0.1:8080/api/NuevaMision//{fechaInicio}/{idNave}/{capitanes}/{numTripulacion}/{planetas} */
  @PostMapping("/NuevaMision/{fechaInicio}/{idNave}/{capitanes}/{numTripulacion}/{planetas}")
  public ResponseEntity<Object> addMision(@PathVariable Map<String, String> pathVarsMap){
	  ...
	  return MisionService.save(fechaInicio, idNave, capitanes, numTripulacion, planetas);
